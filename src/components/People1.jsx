...
export const People = ( { people, setPeople } ) => {
  ...
  //Estado para eliminar (gestiona a la persona)
  ...
  const handleSave = (e) => {
    ...
    //Prevenir recarga auto del navegador.
    e.preventDefault();
    ...
    //Actualizar el estado de las personas con el array actualizado
  ...
  //Método #1: Toma la persona a la que se eliminará
  const handleDelete = (id) => {
    setPersonToDelete (id);
  }

  //Método #2: Confirma la eliminación.
  const confirmDelete = () => {
  ...
  //Metodo 3# Cancelar la eliminación.
  const cancelDelete = () => {
    setPersonToDelete(null);
  };
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-secundary" data-bs-toggle="modal"  onClick={cancelDelete}>Cancelar</button>
              <button type="button" className="btn btn-danger" data-bs-toggle="modal"  onClick={confirmDelete}>Estoy seguro</button>
            </div>
          </div>
        </div>
      </div>
